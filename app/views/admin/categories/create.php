<?php
/**
 * Admin Categories - Create View
 */
$pageTitle = 'Create Category';
$breadcrumb = 'Home / Categories / Create';
ob_start();
?>
...
<div class="form-card">
    <div class="form-header">
        <h2 class="form-title">
            <i class="fas fa-folder-plus"></i> <?= htmlspecialchars($title) ?>
        </h2>
    ...
    <div class="form-body">
        <form action="<?= View::url('/admin/categories/store') ?>" method="POST">
            ...
            <div class="form-row">
                ...
                <div class="form-group">
                    ...
                    <?php endif; ?>
                    <small class="form-text">URL-friendly version of the name. Leave empty to auto-generate.</small>
                </div>
            </div>
            ...
            <div class="form-row">
                <div class="form-group">
                    ...
                    <select id="type" name="type" class="form-control" required>
                        ...
                        <option value="our-products" <?= ($old['type'] ?? '') === 'our-products' ? 'selected' : '' ?>>
                            Our Products
                        </option>
                    </select>
