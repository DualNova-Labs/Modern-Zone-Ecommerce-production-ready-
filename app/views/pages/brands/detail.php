        ...
        <div class="brand-hero-content">
            <div class="brand-logo-container">
                <div class="brand-logo-circle">
                    <?php
                    // Handle logo path - check if it's a full path or just filename
                    ...
                    ?>
                    <img src="<?= $logoPath ?>" alt="<?= htmlspecialchars($brand['name']) ?> Logo"
            ...
            <p class="brand-tagline">
                <?= htmlspecialchars($brand['description'] ?? 'Premium quality industrial tools and equipment') ?></p>
...
<section class="brand-products">
    <div class="container">
        <div class="section-header">
            ...
            <p class="section-subtitle">Discover our range of <?= htmlspecialchars($brand['name']) ?> tools and
                equipment</p>
        </div>
            ...
            <div class="brand-products-layout">
                ...
                <div class="products-content">
                    <div class="products-header">
                        <p class="products-count">Showing <span id="productCount"><?= count($products) ?></span> of
                                ...
                                <div class="product-card">
                                    <div class="product-image">
                                        ...
                                        <?php if (!empty($product['subcategory_name'])): ?>
                                            <div class="product-badge subcategory-badge">
                                                <?= htmlspecialchars($product['subcategory_name']) ?></div>
                                        <?php else: ?>
        ...
        <?php else: ?>
            <div class="no-products">
                ...
                <p>No products available
                    <?= isset($current_subcategory) && $current_subcategory ? 'in this category' : 'for this brand' ?> at
                    the moment.</p>
                <?php if (isset($current_subcategory) && $current_subcategory): ?>
                    <a href="<?= View::url('/products?brand=' . $brand['slug']) ?>" class="btn btn-primary">View All
                        <?= htmlspecialchars($brand['name']) ?> Products</a>
                <?php else: ?>
