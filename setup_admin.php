 ...
 * Run this from the browser: http://localhost/Modern-Zone-Ecommerce-production-ready-/setup_admin.php
 */
...
try {
    ...
    echo "<p style='color: orange;'><strong>Security Note:</strong> Delete this file after use!</p>";
