...
function initMobileMenu() {
    ...
    if (window.innerWidth <= 768) {
        ...
        // Handle nested submenu items (brands with categories)
        ...
        hasSubmenuItems.forEach(item => {
            ...
            if (span) {
                span.addEventListener('click', function (e) {
                    ...
                    const siblings = item.parentElement.querySelectorAll('.main-nav-dropdown-item.has-submenu');
...
// ========================================
// PRODUCTS PAGE - FILTER SIDEBAR (Mobile)
// ========================================
...
// ========================================
// PRODUCT DETAIL PAGE - MOBILE INTERACTIONS
// ========================================
...
function initProductDetail() {
    ...
    // Smooth scroll for gallery thumbs
